...
class Battle::Scene  
  ...
  def pbUpdateMoveInfoWindow(battler, specialAction, cw)
    ...
    if specialAction == :zmove && cw.mode == 2
      move = move.convert_zmove(battler, @battle, cw.index)
    ...
    imagePos = [
      ...
      ["Graphics/UI/types",    xpos + 282+19, ypos + 8, 0, typenumber * 28, 64, 28],
      ["Graphics/UI/category", xpos + 350+19, ypos + 8, 0, category * 28, 64, 28]
    ]
    ...
    textPos.push(
      [move.name,       xpos + 12,  ypos + 12, :left,   BASE_LIGHT, SHADOW_LIGHT, :outline],
      [_INTL("Potencia:"),    xpos + 256-134+132+3, ypos + 40, :left,   BASE_LIGHT, SHADOW_LIGHT],
      [displayPower,    xpos + 310-88+132+3, ypos + 40, :center, powBase,    powShadow],
      [_INTL("Precisión:"),    xpos + 348-98+132+3, ypos + 40, :left,   BASE_LIGHT, SHADOW_LIGHT],
      [displayAccuracy, xpos + 402-50+132+3, ypos + 40, :center, accBase,    accShadow],
      [_INTL("Prioridad:"),    xpos + 442-62+132+3, ypos + 40, :left,   BASE_LIGHT, SHADOW_LIGHT],
      [displayPriority, xpos + 484-4+132+3, ypos + 40, :center, priBase,    priShadow],
      [_INTL("Efecto:"),    xpos + 442-62+132+3, ypos + 12, :left,   BASE_LIGHT, SHADOW_LIGHT],
      [displayChance,   xpos + 484-4+132+3, ypos + 12, :center, effBase,    effShadow]
    )
