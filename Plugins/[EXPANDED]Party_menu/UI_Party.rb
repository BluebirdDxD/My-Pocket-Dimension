...
class PokemonPartyCancelSprite2 < PokemonPartyConfirmCancelSprite
  def initialize(viewport = nil)
    super(_INTL("CANCELAR"), 398, 345, true, viewport)
  end
end
...
class PokemonPartyPanel < Sprite
  ...
  def refresh_hp_bar_graphic
    ...
    @hpbgsprite.x     = self.x + 420
    @hpbgsprite.y     = self.y + 24
  ...
  def draw_level
    ...
    pbDrawImagePositions(@overlaysprite.bitmap,
                         [[_INTL("Graphics/UI/Party/overlay_lv"), @levelX,@levelY, 0, 0, 22, 14]])
    # Level number
    pbSetSmallFont(@overlaysprite.bitmap)
    pbDrawTextPositions(@overlaysprite.bitmap,
                        [[@pokemon.level.to_s, 273,@levelY, :left, TEXT_BASE_COLOR, TEXT_SHADOW_COLOR]])
    pbSetSystemFont(@overlaysprite.bitmap)
  end
  ...
  def draw_gender
    ...
    pbDrawTextPositions(@overlaysprite.bitmap,
                        [[gender_text, @genderX,@genderY, :left, base_color, shadow_color]])
  end
  ...
  def draw_hp
    ...
    pbDrawTextPositions(@overlaysprite.bitmap,
                        [[hp_text, @hpbarX,@hpbarY, :right, TEXT_BASE_COLOR, TEXT_SHADOW_COLOR]])
    # HP bar
    if @pokemon.able?
      ...
      @overlaysprite.bitmap.blt(450, 26, @hpbar.bitmap, hprect)
    end
  end
