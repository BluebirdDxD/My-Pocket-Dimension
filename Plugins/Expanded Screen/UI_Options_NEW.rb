...
class UI::OptionsVisuals < UI::BaseVisuals
  ...
  TEXT_COLOR_THEMES = {   # Themes not in DEFAULT_TEXT_COLOR_THEMES
    :page_name        => [Color.new(248, 248, 248), Color.new(74, 112, 175)],
    :option_name      => [Color.new(246, 198, 6), Color.new(74, 97, 103)],
    :unselected_value => [Color.new(248, 248, 248), Color.new(74, 112, 175)],
    :selected_value   => [Color.new(247, 100, 90), Color.new(203, 33, 12)],
