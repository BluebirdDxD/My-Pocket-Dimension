...
class Battle::Scene::PokemonDataBox < Sprite
  ...
  ENEMY_NAME_SHIFT_X    = -6
  ENEMY_LEVEL_SHIFT_X   = 10+8+2
  ENEMY_GENDER_SHIFT_X  = -4 + 84 - 64 - 10-8+2
  PLAYER_NAME_SHIFT_X   = 24-8
  PLAYER_LEVEL_SHIFT_X  = 36
  PLAYER_GENDER_SHIFT_X = 56 - 48+8
...
#    pbSetSmallFont(@hpNumbers.bitmap)
  ...
  if [0, 1].include?(gender)
    ...
    pbDrawImagePositions(self.bitmap, [["Graphics/UI/Summary/icon_genders", gender_x, gender_y-1, src_x, src_y, width, height]])
  end
end
  ...
  def draw_shiny_icon
    ...
    shiny_x = (@battler.opposes?(0)) ? 206 : -6-4   # Foe's/player's
