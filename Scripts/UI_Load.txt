  ...
  def refresh
    ...
    if @refreshBitmap
      ...
      if @isContinue
        ...
        if @trainer.male?
          textpos.push([@trainer.name, 112+desplaz_menu, 70, :left, MALE_TEXT_COLOR, MALE_TEXT_SHADOW_COLOR])
        elsif @trainer.female?
          textpos.push([@trainer.name, 112+desplaz_menu, 70, :left, FEMALE_TEXT_COLOR, FEMALE_TEXT_SHADOW_COLOR])
        else
          textpos.push([@trainer.name, 112+desplaz_menu, 70, :left, TEXT_COLOR, TEXT_SHADOW_COLOR])
        end
